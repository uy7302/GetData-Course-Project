...
1. timebodygyrojerkmagmean: num  -0.963 -0.992 -0.995 -0.299 -0.295 ...
  - Derived quantity from the "body gyro jerk mean" which in turn is the angular velocity component of the gyro measurement in the Y-Axis in the time domain.
1. freqbodyaccmeanx       : num  -0.9391 -0.9796 -0.9952 -0.2028 0.0382 ...
  - Derived quantity from the "body gyro jerk mean" which in turn is the angular velocity component of the gyro measurement in the Z-Axis in the time domain.

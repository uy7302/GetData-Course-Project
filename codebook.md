...
1. timegravityaccmagmean  : num  -0.8419 -0.9485 -0.9843 -0.137 0.0272 ...
  - Derived quantity (mean) from the "gravity acceleration" component of the accelerometer measurement in the time domain.
...
1. timebodygyromagmean    : num  -0.8748 -0.9309 -0.9765 -0.161 -0.0757 ...
  - Derived quantity (mean) from the "body gyro jerk mean" which in turn is the angular velocity component of the gyro measurement in the X-Axis in the time domain.
...
1. freqbodyaccmagmean     : num  -0.8618 -0.9478 -0.9854 -0.1286 0.0966 ...
  - Derived quantity from the "body acceleration jerk" component which in turn is the body acceleration component of the accelerometer measurement in the frequency domain.
...
1. timebodyaccstdy        : num  -0.8368 -0.9226 -0.9732 0.1145 -0.0319 ...
  - Standard Deviation of the body acceleration component for the accelerometer measurement in the Y-Axis in the time domain.
1. timebodyaccstdz        : num  -0.826 -0.94 -0.98 -0.26 -0.23 ...
  - Standard Deviation of the body acceleration component for the accelerometer measurement in the Z-Axis in the time domain.
1. timegravityaccstdx     : num  -0.897 -0.968 -0.994 -0.977 -0.951 ...
  - Standard Deviation of the gravity acceleration component for the accelerometer measurement in the X-Axis in the time domain.
1. timegravityaccstdy     : num  -0.908 -0.936 -0.981 -0.971 -0.937 ...
  - Standard Deviation of the gravity acceleration component for the accelerometer measurement in the Y-Axis in the time domain.
1. timegravityaccstdz     : num  -0.852 -0.949 -0.976 -0.948 -0.896 ...
  - Standard Deviation of the gravity acceleration component for the accelerometer measurement in the Z-Axis in the time domain.
1. timebodyaccjerkstdx    : num  -0.9585 -0.9864 -0.9946 -0.1136 -0.0123 ...
  - Derived Standard Deviation from the body acceleration component of the accelerometer measurement in the X-Axis in the time domain.
1. timebodyaccjerkstdy    : num  -0.924 -0.981 -0.986 0.067 -0.102 ...
  - Derived Standard Deviation from the body acceleration component of the accelerometer measurement in the Y-Axis in the time domain.
1. timebodyaccjerkstdz    : num  -0.955 -0.988 -0.992 -0.503 -0.346 ...
  - Derived Standard Deviation from the body acceleration component of the accelerometer measurement in the Z-Axis in the time domain.
1. timebodygyrostdx       : num  -0.874 -0.977 -0.987 -0.474 -0.458 ...
  - Standard Deviation of the body angular velocity for the gyro measurement in the X-Axis in the time domain.
1. timebodygyrostdy       : num  -0.9511 -0.9665 -0.9877 -0.0546 -0.1263 ...
  - Standard Deviation of the body angular velocity for the gyro measurement in the Y-Axis in the time domain.
1. timebodygyrostdz       : num  -0.908 -0.941 -0.981 -0.344 -0.125 ...
  - Standard Deviation of the body angular velocity for the gyro measurement in the Z-Axis in the time domain.
1. timebodygyrojerkstdx   : num  -0.919 -0.992 -0.993 -0.207 -0.487 ...
  - Derived Standard Deviation from the angular velocity component of the gyro measurement in the X-Axis in the time domain. 
1. timebodygyrojerkstdy   : num  -0.968 -0.99 -0.995 -0.304 -0.239 ...
  - Derived Standard Deviation from the angular velocity component of the gyro measurement in the Y-Axis in the time domain. 
1. timebodygyrojerkstdz   : num  -0.958 -0.988 -0.992 -0.404 -0.269 ...
  - Derived Standard Deviation from the angular velocity component of the gyro measurement in the Z-Axis in the time domain. 
1. timebodyaccmagstd      : num  -0.7951 -0.9271 -0.9819 -0.2197 0.0199 ...
  - Derived quantity (Standard Deviation) from the "body acceleration jerk" component which in turn is the body acceleration component of the accelerometer measurement in the time domain.
1. timegravityaccmagstd   : num  -0.7951 -0.9271 -0.9819 -0.2197 0.0199 ...
  - Derived quantity (Standard Deviation) from the "gravity acceleration" component of the accelerometer measurement in the time domain.
1. timebodyaccjerkmagstd  : num  -0.9282 -0.9841 -0.9931 -0.0745 -0.0258 ...
  - Derived quantity (standard Deviation) from the "body acceleration jerk" component which in turn is the body acceleration component of the accelerometer measurement in the time domain.
1. timebodygyromagstd     : num  -0.819 -0.935 -0.979 -0.187 -0.226 ...
  - Derived quantity (Standard Deviation) from the "body gyro jerk mean" which in turn is the angular velocity component of the gyro measurement in the X-Axis in the time domain.
1. timebodygyrojerkmagstd : num  -0.936 -0.988 -0.995 -0.325 -0.307 ...
  - Derived quantity (Standard Deviation) from the "body gyro jerk mean" which in turn is the angular velocity component of the gyro measurement in the time domain.
1. freqbodyaccstdx        : num  -0.9244 -0.9764 -0.996 -0.3191 0.0243 ...
  - Standard Deviation of the body acceleration component for the accelerometer measurement in the X-Axis in the frequency domain.
1. freqbodyaccstdy        : num  -0.834 -0.917 -0.972 0.056 -0.113 ...
  - Standard Deviation of the body acceleration component for the accelerometer measurement in the Y-Axis in the frequency domain.
1. freqbodyaccstdz        : num  -0.813 -0.934 -0.978 -0.28 -0.298 ...
  - Standard Deviation of the body acceleration component for the accelerometer measurement in the Z-Axis in the frequency domain.
1. freqbodyaccjerkstdx    : num  -0.9642 -0.9875 -0.9951 -0.1336 -0.0863 ...
  - Derived Standard Deviation from the body acceleration component of the accelerometer measurement in the X-Axis in the frequency domain.
1. freqbodyaccjerkstdy    : num  -0.932 -0.983 -0.987 0.107 -0.135 ...
  - Derived Standard Deviation from the body acceleration component of the accelerometer measurement in the Y-Axis in the frequency domain.
1. freqbodyaccjerkstdz    : num  -0.961 -0.988 -0.992 -0.535 -0.402 ...
  - Derived Standard Deviation from the body acceleration component of the accelerometer measurement in the Z-Axis in the frequency domain.
